       ...
       // private readonly string _authToken;
        ...
        public ServiceResponse<string> SaveGSTRI(WEP.GSP.Document.Attrbute objAttr)
        {
            ...
            catch (Exception e)
            {
                ...
                var exe = new ExceptionModel { ErrorMessage = e.Message };
        ...
        public IHttpActionResult GetAll()
        {
            try
            {
                ...
                this._authToken = "8a227e0ba56042a0acdf98b3477d2c03";
                this._txn = "returns";
                this._statecd = "11";
                this._clientSecret = "30a28162eb024f6e859a12bbb9c31725";
                this._clientid = "l7xxdf2b47b7d728426699a05c8d1ec33a60";
                this._username = "WeP";
                this._ipUsr = "12.8.9l.80";

                string url = "http://localhost:2277/Home/SaveGSTRI";
        ...
        public async Task<IHttpActionResult> SignIn()
        {
            ...
            string url = "http://localhost:2277/Home/SignIn";
